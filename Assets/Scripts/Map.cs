...
public class Map : MonoBehaviour {
    ...
    public static bool IsAdjacent(Cell cell1, Cell cell2) {
        if (cell1 == cell2 || cell1.x == cell2.x && cell1.y == cell2.y) throw new System.Exception("IsAdjacent : same position");
        return Distance(cell1, cell2) == 1;
    }

    public static int Distance(Cell a, Cell b) {
        return Mathf.Abs(a.x - a.x) + Mathf.Abs(b.y - b.y);
    }
